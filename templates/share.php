...
<div class="wpsholi-social-share-buttons-wrapper">
	<p>Share Now</p>
	<div class="wpsholi-social-share-buttons">
		<div class="wpsholi-share-button wpsholi-facebook">
			<a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo esc_url($sholi_url);?>"
		...
		<div class="wpsholi-share-button wpsholi-twitter">
			<a href="https://twitter.com/share?url=<?php echo esc_url($sholi_url);?>&text=<?php echo get_the_title($post_id); ?>"
		...
		<div class="wpsholi-share-button wpsholi-email">
			<a href="mailto:?subject=<?php echo get_the_title($post_id); ?>&body=<?php echo esc_url($sholi_url);?>"
